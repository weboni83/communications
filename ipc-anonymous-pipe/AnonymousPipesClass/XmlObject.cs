...
namespace Tools
{
    ...
    public class XmlObject
    {
        ...
        public XmlObject(String rootElementName)
        {
        ...
        private String EncodeIllegalCharacters(String text)
        {
            ...
            text = text.Contains("&") ? text.Trim() : text;

            // Reformat any illegal characters:
        ...
        {
            XmlObject newElement = new XmlObject(Name)
            {
                parent = this
            };
        ...
        public bool GetXmlObject(String path, ref XmlObject o)
        {
            ...
            List<KeyValuePair<XmlObjectType, Object>> thisContent = new List<KeyValuePair<XmlObjectType, Object>>
            {
                ...
                new KeyValuePair<XmlObjectType, Object>(XmlObjectType.Element, this)
            };
        ...
        private static bool ParseXml(String rawXml, ref List<XmlObject> xmlData)
        {
            ...
            while (!xml.EOF)
            {
                ...
                else
                {
                    ...
                    tmpObject = new XmlObject(xml.Name);
